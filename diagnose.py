"""
Direct diagnostic: 3 tier-3 episodes against Fireworks deployment.
...
MODEL      = "accounts/vihari5tejo-c218bcay/deployments/metnvyc4"
MAX_TOKENS = 10000
TIER       = 3
N_RECORDS  = 3
...
async def main():
    ...
    print(f"\n{'='*60}")
    print(f"Results across {len(SEEDS)} runs:")

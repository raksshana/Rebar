    ...
    <section style={{
      ...
      <div style={{ maxWidth:780 }}>
        ...
        <h1 style={{ margin:0, fontSize:74, lineHeight:.96, fontWeight:700, letterSpacing:'-.03em', textShadow:'0 0 30px rgba(139,123,255,.18)' }}>
          ...
          <span style={{ display:'block', background:'linear-gradient(100deg,#8b7bff,#2fe6d6)', WebkitBackgroundClip:'text', backgroundClip:'text', color:'transparent', animation:'heroFadeIn 0.7s ease 0.4s forwards', opacity:0 }}>
            Verify every record.
          </span>
        </h1>
        <p style={{ margin:'30px 0 0', maxWidth:580, fontSize:17, lineHeight:1.55, color:'#9aa3b8', animation:'heroFadeIn 0.7s ease 0.55s forwards', opacity:0 }}>
